        ...
        <div className="p-6">
          ...
          <div className="flex flex-wrap gap-4">
            <button
              ...
              className="px-6 py-3 rounded-lg bg-gradient-to-r from-green-500 to-blue-500 font-medium hover:from-green-400 hover:to-blue-400 transition-colors duration-300 flex-1 text-white"
            >
              ✅ Select Template
            </button>
            <button
